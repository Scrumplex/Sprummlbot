...
public class Site_bans {
	...
	public Site_bans() {
		...
		if (bans != null)
			for (Ban ban : bans)
				sb.append("<tr><td>").append(ban.getBannedUId()).append("</td><td>").append(ban.getBannedIp())
						.append("</td><td>").append(ban.getReason())
						.append("</td><td><a class=\"waves-effect waves-light btn\" href=\"/manage/action/unban/!id=")
						.append(ban.getId()).append("\"><i class=\"material-icons right\">done</i>Unban</a></td>");
