package net.scrumplex.sprummlbot.web.func;

import com.github.theholywaffle.teamspeak3.api.CommandFuture;
import net.scrumplex.sprummlbot.Vars;
import net.scrumplex.sprummlbot.web.manage.Site_ban;
import net.scrumplex.sprummlbot.web.manage.Site_clearaccounts;
import net.scrumplex.sprummlbot.web.manage.Site_kick;
import net.scrumplex.sprummlbot.web.manage.Site_unban;
import net.scrumplex.sprummlbot.web.Site_index;
import net.scrumplex.sprummlbot.web.manage.*;
...
public class Actions {
    ...
    public static String shutdown() {
        ...
        t.start();
        return new Site_shutdown().content;
    }
    ...
    public static String poke(int userid, String msg) {
        ...
        return new net.scrumplex.sprummlbot.web.Site_index().content;
    }
