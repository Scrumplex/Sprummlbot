...
public class Site_index {
    ...
    public Site_index() {
        ...
        try {
            ...
            sb.append("        <p style=\"color:#fff\">There are currently ").append(Vars.API.getServerInfo().get().getClientsOnline() - 1).append(" user(s) and the Sprummlbot on your server!</p>");
            sb.append("    </div>");
            sb.append("");
            sb.append(
            ...
            if (Vars.API.getBans() != null) {
                bancount = Vars.API.getBans().get().size();
            }
